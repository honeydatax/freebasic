...
sub grid()
          dim n as integer
          line(0,0)-(32*6,32*6),0,b
          for n=0 to 31
                    line(0,n*6)-(32*6,n*6),0
                    line(n*6,0)-(n*6,32*6),0
          next n             
end sub                 
...
sub draws()
          ...
          for m=0 to 31
                    for n=0 to 31
                              cc=point(260+n,m)
                              line(n*6,m*6)-((n+1)*6,(m+1)*6),cc,bf
                    next n                
          next m                
          screenunlock
end sub                
...
sub click2()
          ...
          do                
                    ...
                    loop                
                    if bt=1 and functi<>0 and x>0 and x< 32*6 and y>0 and y<32*6 then
                              ccx=x\6                
                              ccy=y\6        
                              exit do                
                    end if                
...
do                
          ...
          if bt=1 and functi=0 and x>0 and x< 32*6 and y>0 and y<32*6 then
                    cx=x\6            
                    cy=y\6          
                    line(cx*6,cy*6)-((cx+1)*6,(cy+1)*6),c,bf
                    pset(260+cx,cy),c
                    goto escapeloop
          end if                
          if bt=1 and functi=1 and x>0 and x< 32*6 and y>0 and y<32*6 then
                    cx=x\6    
                    cy=y\6                
                                    
                    click2           
                    line(260+cx,cy)-(260+ccx,ccy),c
                    draws                
                    goto escapeloop
          end if            
          if bt=1 and functi=2 and x>0 and x< 32*6 and y>0 and y<32*6 then
                    cx=x\6          
                    cy=y\6                
                                    
                    click2           
                    circle(260+cx,cy),(abs(cx-ccx)+abs(cy-ccy))\2,c,,,1.0,f
                    draws                
                    goto escapeloop
          end if                
          if bt=1 and functi=3 and x>0 and x< 32*6 and y>0 and y<32*6 then
                    cx=x\6           
                    cy=y\6                
                                    
                    click2           
                    line(260+cx,cy)-(260+ccx,ccy),c,bf
                    draws                
                    goto escapeloop
          end if                
          escapeloop:
