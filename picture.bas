...
dim images As Any Ptr=ImageCreate(64,64,rgb(255,255,255) )
                
bload "marina.bmp", images
...
i=creatWindows(win,160,160,100,100,rgb(255,255,255),"picture",true)
                
cc.x=5                
cc.y=TitleBarSize+5
cc.r=75                
                
put win.win(i).images,(1,TitleBarSize),images,pset
ImageDestroy images
                
do                
          for ii=1 to win.count-2
                    if ii<>8 then drawClsWindow win,ii
          next ii                
